...
?>
			...
			<div class="uoj-footer">
				...
				<?php endif ?>
				<p><?= UOJLocale::get('server time') ?>: <?= UOJTime::$time_now_str ?> | <a href="https://github.com/user111192/UOJ-System" target="_blank"><?= UOJLocale::get('opensource project') ?></a> fork</p>
			</div>
			<?php endif ?>
		</div>
		<!-- /container -->
